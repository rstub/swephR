...
fixstar2_ut <- function(star, jd_ut, iflag) {
    .Call(`_swephR_fixstar2_ut`, star, jd_ut, iflag)
}

fixstar2 <- function(star, jd_et, iflag) {
    .Call(`_swephR_fixstar2`, star, jd_et, iflag)
}
