...
6. Here is a miniature sample program described in Chapter 0 of the programma's manual of SE ([see also](http://www.astro.com/swisseph/swephprg.htm#_Toc505244830)):
```{r}
  options(digits=6)
