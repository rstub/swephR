...
jdut
```
4. Compute (using Moshier ephemeris) the positions (longitude, latitude, distance, longitude speed and latitude speed) of a planet or other celestial bodies (in below example: the Sun and Moon):
```{r}
ipl1 <- SE$SUN
ipl2 <- SE$MOON
